...
const info: Info = {
    ...
    "phone-number": "Don't worry. We won't call you.",
    "recommended-hoa-coverage": "Dwelling coverage protects everything within the walls of your unit, think toilet, countertops, flooring.",
