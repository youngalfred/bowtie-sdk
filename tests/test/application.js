...
module.exports = {
 application: [
  ...
  ['start-address-city', 'Summerville'],
  ['start-address-state', 'Florida'],
  ['start-address-streetAddress', '1234 Main St'],
  ['start-address-unit', 'FL 12'],
  ['start-address-zipCode', '31024'],
  ...
  [
   'home-propertyUse-typeOfUse',
   "It's my primary home and I live here full time",
  ],
  ...
  ['home-heating-updatedYear', daysFromNow(-4105).substring(0, 4)],
  ['home-electrical-hasUpdate', 'Yes'],
  ['home-electrical-updateComplete', 'Partial'],
  ['home-electrical-updatedYear', daysFromNow(-5840).substring(0, 4)],
  ['home-plumbing-hasUpdate', 'Yes'],
  ['home-plumbing-updateComplete', 'Complete'],
  ['home-plumbing-updatedYear', daysFromNow(-6935).substring(0, 4)],
  ['home-valuables-hasBelongingsOver2k-_computerEquipment', 'Yes'],
  ['home-valuables-belongingsOver2k-computerEquipment-value', '> $10,000'],
  ['home-valuables-hasBelongingsOver2k-_jewelry', 'Yes'],
  ['home-valuables-belongingsOver2k-jewelry-value', '$6,000'],
  ...
  [
   'home-protectionSystems-burglarAlarmSystemType',
   'Direct - Alerts Police Department',
  ],
  [
   'home-protectionSystems-fireAlarmSystemType',
   'Direct - Alerts Fire Department',
  ],
  ...
  ['home-claims-0-date', daysFromNow(-400).substring(0, 7)],
  ...
  [
   'home-risks-unrepairedDamagesDescription',
   'Hole in the floor near dining room',
  ],
