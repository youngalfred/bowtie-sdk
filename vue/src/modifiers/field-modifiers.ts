...
const idModifierMap: Record<string, BaseConverter<InputNode, InputNode>> = {
  ...
  ...assignModifierToFieldsByPrefixes(toCardGroup())(
    ...
    [
      'home.discounts.',
      ['deadbolts', 'doorman', 'smokerFree', 'stormShutters', 'hailResistantRoof'],
    ],
    [
      'home.propertyStyle.',
      [
    ...
    ['home.roof.roofShape.', ['gable', 'hip', 'gambrel', 'mansard', 'shed', 'flat', 'complex']],
    ['home.risks.', ['none', 'trampoline', 'swimmingPool.hasSwimmingPool', 'sumpPump']],
    ['home.plan.requestedPlanType.', ['premium', 'standard', 'basic']],
    ['home.heating.fuelType.', ['oil', 'electric', 'naturalGas', 'propane']],
  ),
